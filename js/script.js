let eventos = []; //se guarda en un arreglo porque son varios eventos
let arr =[]; 
...
function agregarEvento(){
    ...
    eventos.unshift(nuevoEvento) //mandar cada parametro de nuevoEvento al arreglo eventos
...
function mostrarEventos() {
    const eventosHTML = eventos.map(evento => {
        ...
        <div class="evento">
            <div class="dias">
                <span class="diasFaltante">${diferenciaFecha(evento.fecha)}</span>
